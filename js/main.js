document.addEventListener("DOMContentLoaded", function () {
    ...
    //     };
    // }
    // output.node().addEventListener('mousemove', function (event) {
    ...
    var colorRampLines = d3.scaleLinear()
        ...
        .range(["rgba(172,69,145,0.2)", "rgba(51,51,51,0)"]);
    ...
    function step(time) {
        ...
        dots.forEach(function (d, i) {
            if (stepNum === 1) {
                ...
                d.x = xScale(i);
                d.y = (height / 2) + ((d.radius * 50) - 25) - (Math.sin((time * 0.0001) + d.x * 0.01) * (height / 4));
            } else if (stepNum === 3) {
                d.x = width / 2;
                d.y = height / 2;
            }
